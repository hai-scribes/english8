...
// tools/assets/auth-src.mjs
var cfg = window.__EN8_FIREBASE__;
var stateEl = document.querySelector("[data-en8-auth-state]");
var signinBtn = document.querySelector("[data-en8-signin]");
var signoutBtn = document.querySelector("[data-en8-signout]");
var idEl = document.querySelector("[data-en8-identity]");
function setState(s) {
...
function paintSignedIn(user) {
  setState("signed-in");
  if (idEl) {
    idEl.textContent = user.email || user.displayName || user.uid;
    idEl.hidden = false;
  }
