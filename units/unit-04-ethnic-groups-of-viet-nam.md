...
> để ý câu *Who looks after the house?* — không có trợ động từ *does*. Chi tiết
> đầy đủ ở Lesson 3.
...
| --- | --- | --- | --- | --- |
| 1 | ethnic group | /ˈeθnɪk ɡruːp/ | n | dân tộc, nhóm dân tộc |
| 2 | ethnic minority | /ˌeθnɪk maɪˈnɒrəti/ | n | dân tộc thiểu số |
| 3 | majority | /məˈdʒɒrəti/ | n | đa số, phần đông |
| 4 | custom | /ˈkʌstəm/ | n | phong tục, tập quán |
| 5 | costume | /ˈkɒstjuːm/ | n | trang phục (truyền thống) |
| 6 | stilt house | /ˈstɪlt haʊs/ | n | nhà sàn |
| 7 | terraced field | /ˌterəst ˈfiːld/ | n | ruộng bậc thang |
| 8 | heritage | /ˈherɪtɪdʒ/ | n | di sản |
| 9 | ritual | /ˈrɪtʃuəl/ | n | nghi lễ, nghi thức |
| 10 | folk song | /ˈfəʊk sɒŋ/ | n | dân ca |
| 11 | bamboo | /ˌbæmˈbuː/ | n | cây tre, tre nứa |
| 12 | weave | /wiːv/ | v | dệt, đan |
| 13 | basket | /ˈbɑːskɪt/ | n | cái giỏ, cái rổ |
| 14 | gong | /ɡɒŋ/ | n | cái cồng, cái chiêng |
| 15 | cave | /keɪv/ | n | hang động |
...
These two sounds are made in exactly the same place — the back of the tongue
against the soft palate. The **only** difference is voice.

| | /k/ — voiceless | /ɡ/ — voiced |
| --- | --- | --- |
| **Voice box** | silent, no buzz | buzzing |
| **Air** | a small puff of air at the start of a word | almost no puff |
| **Test** | cover your ears and say it — quiet | cover your ears — you hear a hum inside your head |
| **Examples** | **c**oat, **c**ustom, **c**ostume, **c**ave, **c**ulture, mar**k**et, bas**k**et, fol**k** | **g**oat, **g**roup, **g**ong, **g**arment, **g**uitar, ethnic **g**roup, lan**g**uage |

**Spelling traps — check the sound, not the letter:**

- **gh** in *ghost* /ɡəʊst/ is a plain /ɡ/ — the **h** is silent.
- **c** in *ceremony* /ˈserəməni/ is /s/, **not** /k/. Before *e*, *i* and *y*,
  the letter *c* is usually /s/: *ceremony, city, cycle*.
- **g** in *village* /ˈvɪlɪdʒ/ is /dʒ/, **not** /ɡ/.
...
A Yes/No question can be answered with *yes* or *no*. English makes one by
putting an operator **in front of the subject**.

| The statement has… | Do this | Example |
| --- | --- | --- |
| **be** (*am / is / are / was / were*) | move *be* to the front | She **is** Tay. → **Is** she Tay? |
| **a modal** (*can, could, will, should, must*) | move the modal to the front | He **can** weave. → **Can** he weave? |
| **only a main verb** | add **do / does / did** | They **live** here. → **Do** they **live** here? |

⚠️ When you add *do / does / did*, the main verb goes back to its **base form**.

> ✅ **Does** your grandmother **weave** baskets?
> ❌ *Does your grandmother weaves baskets?*
> ✅ **Did** you **visit** the village last summer?
> ❌ *Did you visited the village last summer?*

**Short answers** repeat the operator, never the main verb:

> *Is it a stilt house?* — **Yes, it is.** / **No, it isn't.**
> *Do they grow rice?* — **Yes, they do.** / **No, they don't.**
> *Can you play the gong?* — **Yes, I can.** / **No, I can't.**

### Grammar B — Wh- questions

A Wh- question asks for information. The pattern is:

**Wh- word + operator + subject + main verb + …?**

| Wh- word | Asks about | Nghĩa | Example |
| --- | --- | --- | --- |
| what | a thing | cái gì | **What** is your costume made of? |
| where | a place | ở đâu | **Where** do the Tay live? |
| when | a time | khi nào | **When** does the festival start? |
| why | a reason | tại sao | **Why** do they build houses on stilts? |
| who | a person | ai | **Who** did you visit? |
| how many | number (countable) | bao nhiêu | **How many** rooms are there? |
| how much | amount (uncountable) | bao nhiêu | **How much** rice do they grow? |
| how long | duration | bao lâu | **How long** did you stay? |

### Grammar C — Subject questions: the real trap

When *who* or *what* is the **subject** of the sentence — when it stands where
the doer stands — you do **not** use *do / does / did*. The word order stays
exactly like a statement.

> **My uncle** repairs the roof. → **Who repairs the roof?** ✅
> ❌ *Who does repair the roof?*
>
> **Bamboo** makes the walls strong. → **What makes the walls strong?** ✅
> ❌ *What does make the walls strong?*

Compare the two kinds carefully:

| | Question | Notice |
| --- | --- | --- |
| **Subject question** | **Who lives** in the stilt house? | no *does*; verb takes **-s** |
| **Object question** | **Who does** she **live** with? | *does* + base verb |
| **Subject question** | **What happened** at the festival? | no *did* |
| **Object question** | **What did** you **see** at the festival? | *did* + base verb |

### Grammar D — Countable and uncountable nouns

**Countable** nouns can be counted: *one basket, two baskets*. They have a
plural form.
**Uncountable** nouns cannot be counted directly: they have **no plural -s** and
never take *a / an*.

| Countable | Uncountable |
| --- | --- |
| a basket / two baskets | rice |
| a house / three houses | food |
| a song / many songs | music |
| a suggestion / some suggestions | advice |
| a fact / some facts | information |
| a shirt / two shirts | clothing |
| a bracelet / five bracelets | jewellery |

| Use | With countable | With uncountable |
| --- | --- | --- |
| singular | **a / an** basket | — |
| indefinite quantity (+) | **some** baskets | **some** rice |
| indefinite quantity (– / ?) | **any** baskets | **any** rice |
| large quantity (– / ?) | **many** baskets | **much** rice |
| large quantity (+) | **a lot of** baskets | **a lot of** rice |
| asking | **How many** baskets? | **How much** rice? |

To count an uncountable noun, put a **unit** in front of it:

> **a piece of** information · **a piece of** advice · **a bowl of** rice ·
> **a bottle of** water · **a bar of** soap · **a loaf of** bread

> ⚠️ **Bẫy thường gặp:** Sáu danh từ dưới đây **không đếm được** trong tiếng
> Anh, dù tiếng Việt vẫn nói "những/các": *information, rice, food, clothing,
> advice, jewellery*. Vì vậy:
> ❌ *many informations* → ✅ **a lot of information**
> ❌ *an advice* → ✅ **a piece of advice**
> ❌ *many rices* → ✅ **a lot of rice**
> ❌ *many jewelleries* → ✅ **a lot of jewellery**
> Nhớ cặp đôi: **How many…?** đi với danh từ đếm được (số nhiều), **How
...
| How many rooms does it have, and who lives there? | |
| What is your home made of? | |
| What are two advantages of a stilt house? | |
| Would you like to live in one? Why / why not? | |

**Step 2 — Speak.** Answer each question **aloud** from your notes, in full
sentences. Then ask the five questions aloud as if you were interviewing
someone — an interview is questions, and questions are this unit's grammar.

**Step 3 — Record and check.** Record yourself on your phone. Listen back and
check three things:

- Did every Wh- question have the right word order — *Wh- + operator + subject
  + verb*? And did your **subject questions** correctly have **no** *do/does*?
...
**Step 1 — Choose.** Pick **one** ethnic group you do not already know well.
Not your own, if you belong to one.

**Step 2 — Write ten questions.** Before you look anything up, write ten
questions you want answered. Use a different question word each time, and make
at least two of them **subject questions**.
...
**Step 3 — Find out.** Use a library book, a museum website, or an interview
with someone who knows. Write the source next to each answer. If two sources
disagree, write both — and say so.

**Step 4 — Build the page.** One A4 page: a short paragraph of **100–120
words**, a picture or a drawing, and your three most interesting facts in a box.

**Step 5 — Present it.** Talk about your group for one minute without reading
word for word. Then invite three questions and answer them.

> **Stretch:** Swap fact files with a classmate. Write **five** new questions
...
order *Wh- + do/does + subject + base verb* — unless they are subject
questions, which take no *do/does*.
